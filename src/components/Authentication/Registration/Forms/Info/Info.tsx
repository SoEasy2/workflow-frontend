    ...
    return (
        <>
          <div className={styles.formInfo__wrapper__title}>
              ...
              <div className={styles.formInfo__description}>lets get started with a few simple steps!</div>
          </div>
          <div className={styles.formInfo__form}>
              { infoInputs.map(i => <DefaultInput type={i.type} key={useId()} name={i.name} label={i.label} /> ) }
